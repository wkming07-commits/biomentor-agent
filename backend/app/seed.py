...
def _seed_industry_cases(db: Session):
    cases = [
        {
            "id": 1, "title": "mRNA COVID-19疫苗：从序列到疫苗仅用42天",
            "industry_direction": "mRNA疫苗 / 生物制药", "company": "BioNTech / Moderna",
            "background": "2020年新冠疫情爆发，传统疫苗开发周期通常需要10-15年。mRNA疫苗平台以其无细胞生产、快速迭代的优势，在获得病毒序列后42天内即完成候选疫苗设计。",
            "problem_statement": "如何在最短时间内开发出安全有效的疫苗？",
            "knowledge_points": ["mRNA治疗", "LNP递送系统", "蛋白质结构预测"],
            "guide_questions": ["mRNA疫苗相比传统疫苗的生产优势是什么？", "LNP在mRNA疫苗中扮演什么角色？"],
            "references": ["Moderna (2020) NEJM", "BioNTech/Pfizer (2020) NEJM"],
            "evaluation_dimensions": ["技术可行性", "安全性", "规模化生产", "监管合规"],
            "difficulty": "medium", "is_featured": True,
        },
        {
            "id": 2, "title": "Prime Medicine：精准基因编辑的产业化",
            "industry_direction": "基因治疗 / 精准医疗", "company": "Prime Medicine",
            "background": "Prime Editing技术的出现使精准基因编辑成为可能。Prime Medicine公司成立于2019年，致力于将Prime Editing转化为治疗遗传病的药物。",
            "problem_statement": "如何将实验室中的精准基因编辑技术转化为可产业化的基因治疗产品？",
            "knowledge_points": ["Prime Editing", "基因治疗", "mRNA治疗"],
            "guide_questions": ["Prime Editing相比CRISPR-Cas9在治疗中有什么优势？", "从技术到产品的转化过程中最大的挑战是什么？"],
            "difficulty": "hard", "is_featured": True,
        },
        {
            "id": 3, "title": "合成生物学制造生物基塑料PHA",
            "industry_direction": "合成生物学 / 生物材料", "company": "Danimer Scientific / Newlight Technologies",
            "background": "塑料污染是全球性环境问题。PHA（聚羟基脂肪酸酯）是微生物天然合成的可降解生物聚合物，但生产成本限制了其商业化。",
            "problem_statement": "如何通过合成生物学手段降低PHA的生产成本，使其在经济上与石油基塑料竞争？",
            "knowledge_points": ["代谢工程", "合成生物学", "生物基材料"],
            "guide_questions": ["PHA的生物合成通路涉及哪些关键酶？", "如何优化代谢流量以提高PHA产量？"],
            "difficulty": "medium", "is_featured": True,
        },
        {
            "id": 4, "title": "AI驱动的蛋白质设计：从AlphaFold到治疗性酶",
            "industry_direction": "AI制药 / 蛋白质工程", "company": "DeepMind / Isomorphic Labs",
            "background": "DeepMind的AlphaFold成功解决了蛋白质结构预测问题。在此基础上，AI驱动的蛋白质设计正在从根本上改变制药工业的研发模式。",
            "problem_statement": "AI设计的蛋白质能否在真实临床场景中发挥作用？",
            "knowledge_points": ["蛋白质结构预测", "AI蛋白质设计", "定向进化"],
            "guide_questions": ["AI预测的蛋白质结构与实验解析的结构有何区别？", "理性设计和定向进化在产业应用中的角色分别是什么？"],
            "difficulty": "hard", "is_featured": True,
        },
        {
            "id": 5, "title": "单细胞组学在精准肿瘤诊断中的应用",
            "industry_direction": "精准医疗 / 肿瘤诊断", "company": "10x Genomics / Mission Bio",
            "background": "单细胞组学技术可以揭示肿瘤内部的细胞异质性，为个性化治疗决策提供关键信息。",
            "problem_statement": "如何将单细胞组学数据转化为可操作的临床诊断信息？",
            "knowledge_points": ["单细胞基础模型", "模型解释性", "肿瘤微环境"],
            "guide_questions": ["单细胞组学如何揭示肿瘤耐药机制？", "AI在单细胞数据分析中扮演什么角色？"],
            "difficulty": "hard", "is_featured": False,
        },
        {
            "id": 6, "title": "细胞培养肉的生物制造",
            "industry_direction": "合成生物学 / 食品科技", "company": "UPSIDE Foods / Mosa Meat",
            "background": "细胞培养肉通过体外培养动物细胞生产肉类产品，有望大幅减少畜牧业的环境影响和动物使用。",
            "problem_statement": "如何将细胞培养肉的生产成本降低到与传统肉竞争的水平？",
            "knowledge_points": ["代谢工程", "合成生物学", "细胞工厂"],
            "guide_questions": ["细胞培养肉生产中生长因子的成本如何降低？", "大规模生物反应器培养面临的技术挑战有哪些？"],
            "difficulty": "medium", "is_featured": False,
        },
    ]
